...
public class NewFriendsListAdapter extends BaseExpandableListAdapter {

    private Context context;
    private List<FriendGroup> friendGroupList;
    private List<FriendGroup> originalList;
    private NewFriendOperationListener friendOperationListener;
    private LayoutInflater layoutInflater;
    private Resources resources;
    private String searchCharacters;

    public NewFriendsListAdapter(Context context, NewFriendOperationListener friendOperationListener,
