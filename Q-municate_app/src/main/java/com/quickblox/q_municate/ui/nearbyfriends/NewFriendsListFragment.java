...
public class NewFriendsListFragment extends BaseFragment implements SearchView.OnQueryTextListener, AbsListView.OnScrollListener {
    ...
    private void initFriendAdapter() {
        ...
        friendsListAdapter = new NewFriendsListAdapter(baseActivity, friendOperationAction, friendGroupList);
    ...
    private void startFriendDetailsActivity(int userId) {
        NewFriendDetailsActivity.start(baseActivity, userId);
    }
    ...
    private void findUsers() {
        ...
        Log.d("Details : ", "Searching User ################ :" + constraint + ":");
    ...
    private class FriendOperationAction implements NewFriendOperationListener {
    ...
    private class FindUserSuccessAction implements Command {
        ...
        public void execute(Bundle bundle) {
            ...
            if (NewFriendsListFragment.this.constraint.equals(constraint)) {
                ...
                onQueryTextChange(NewFriendsListFragment.this.constraint);
            }
