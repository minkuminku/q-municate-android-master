...
import com.quickblox.q_municate.ui.nearbyfriends.NewFriendDetailsActivity;
...
public class MainActivity extends BaseLogeableActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks {
    ...
    public static final int ID_SEARCH_FRIENDS_FRAGMENT = 5;
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position) {
            ...
            case ID_FEEDBACK_FRAGMENT:
                ...
                break;
            case ID_SEARCH_FRIENDS_FRAGMENT:
                fragment = NewFriendDetailsActivity.newInstance();
                break;
        }
