...
public class Consts {
    ...
    // Q-municate release
    public static final String QB_APP_ID = "23888";
    public static final String QB_AUTH_KEY = "kJm4Ujsngf25WJx";
    public static final String QB_AUTH_SECRET = "CGq3gSQjYutu386";
